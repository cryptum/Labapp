...
namespace Negocio
{
    public class GerarPDF
    {
        ...
        public Document GerarFolha(PdfDocument pdfDocument, AnaliseEntidade Analise, List<AmostraImpressaoLaudoDTO> Amostra)
        {
            ...
            tableValores.AddCell(Amostra[0].PhAgua).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].PhAgua).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].PhAgua).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].PhAgua).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell(Amostra[0].Fosforo).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Fosforo).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Fosforo).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Fosforo).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell(Amostra[0].Potassio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Potassio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Potassio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Potassio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mmol/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Calcio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Calcio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Calcio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Calcio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mmol/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Magnesio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Magnesio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Magnesio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Magnesio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mmol/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Aluminio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Aluminio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Aluminio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Aluminio).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mmol/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].AcidezPotencial).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].AcidezPotencial).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].AcidezPotencial).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].AcidezPotencial).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Zinco).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Zinco).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Zinco).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Zinco).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Cobre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Cobre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Cobre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Cobre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Ferro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Ferro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Ferro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Ferro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Manganes).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Manganes).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Manganes).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Manganes).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Boro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Boro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Boro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Boro).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell("mg/dm³").AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[0].Enxofre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].Enxofre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].Enxofre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].Enxofre).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableValores.AddCell(Amostra[0].MateriaOrganica).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[1].MateriaOrganica).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[2].MateriaOrganica).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableValores.AddCell(Amostra[3].MateriaOrganica).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            ...
            tableNomeAmostra.AddCell("1:" + Amostra[0].Nome).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableNomeAmostra.AddCell("2:" + Amostra[1].Nome).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableNomeAmostra.AddCell("3:" + Amostra[2].Nome).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
            tableNomeAmostra.AddCell("4:" + Amostra[3].Nome).AddStyle(normalCent).SetBorder(Border.NO_BORDER);
